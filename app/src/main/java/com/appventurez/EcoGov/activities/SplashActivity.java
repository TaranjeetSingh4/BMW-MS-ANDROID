...
import com.appventurez.EcoGov.cbwtf.activities.CbwtfDashboardActivity;
...
//        fetch.addListener(fetchListener);
    ...
    private void startTimer(){
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                Log.d("SplashActivity", "Timer fired, current flag isNextActivityStarted: " + isNextActivityStarted);
    ...
    private synchronized void navigateToNext(Intent intent) {
        if (!isNextActivityStarted) {
            ...
            Log.d("SplashActivity", "Navigating to next Activity: " + activityName);
            startActivity(intent);
            finish();
        } else {
            String activityName = (intent.getComponent() != null) ? intent.getComponent().getClassName() : "Unknown";
            Log.d("SplashActivity", "Redundant navigation attempt blocked to: " + activityName);
        }
    }
