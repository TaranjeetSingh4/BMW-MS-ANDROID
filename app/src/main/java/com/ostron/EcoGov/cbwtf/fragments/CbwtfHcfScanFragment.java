...
import com.ostron.EcoGov.adapters.BluetoothDevicesAdapter;
import com.ostron.EcoGov.bluetooth.MyBluetoothService;
import com.ostron.EcoGov.cbwtf.adapters.HospitalAdapter;
...
import com.ostron.EcoGov.database.HospitalDao;
import com.ostron.EcoGov.database.HospitalModel;
import com.ostron.EcoGov.database.MyDatabase;
import com.ostron.EcoGov.models.BluetoothDevicesModel;
...
//    }
    ...
    public void getOtp(String otp_value,AlertDialog dialog,TextView errorText,OtpView mOtpView,String h_cOde){
        ...
        Volley.newRequestQueue(getContext()).add(otpRequest);
    }
    ...
    public void checkAttendance(String mHospitalCode,String hos_name){
        ...
        Volley.newRequestQueue(getContext()).add(checkAttendanceRequest);
    }
    ...
    public void markAttendance(String mHospitalCode){
        ...
        Volley.newRequestQueue(getContext()).add(markAttendanceRequest);
    }
